    ...
    args={{
      deputies: [
        ...
        },
        {
          ...
          subtitle: 'Bündnis 90/Die Grünen, Bielefeld – Gütersloh II (WK 132)',
          avatar: {
            profileImage: {
              source: {
                uri:
        ...
        },
        {
          ...
          subtitle: 'SPD, Prignitz – Ostprignitz-Ruppin – Havelland I (WK 56)',
          avatar: {
            profileImage: {
              source: {
                uri:
        ...
        },
        {
          ...
          subtitle: 'CDU/CSU, Chemnitzer Umland – Erzgebirgskreis II (WK 163)',
          avatar: {
            profileImage: {
              source: {
                uri:
